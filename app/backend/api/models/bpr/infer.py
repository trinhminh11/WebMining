...
def demonstrate_predictions(
    ...
    """Demonstrate preference score predictions."""
    print("\n[Predictions] Sample preference scores:")
    print("-" * 40)
    ...
    if not known_users:
        print("  No known users found in sample data.")
        return
...
def main() -> None:
    ...
    print("=" * 60)
    print("Bayesian Personalized Ranking (BPR) Model Inference")
    print("=" * 60)
    ...
    # Use model's known users/items directly
